...
import { WeComQRCode } from './WeComQRCode';
import type { Authenticator } from '@nocobase/plugin-auth/client';

/**
 * Props for WeComSignInButton component
 */
export interface WeComSignInButtonProps {
  /**
 ...
 * - Displays WeComQRCode in a modal on click
 ...
 */
export const WeComSignInButton: React.FC<WeComSignInButtonProps> = ({ authenticator }) => {
    ...
    <>
      ...
      >
        <Space direction="vertical" size="middle" style={{ width: '100%' }}>
          ...
          {/* Display QR Code */}
          {/* Requirements: 2.1 */}
          <WeComQRCode authenticator={authenticator.name} onError={handleError} />
        </Space>
      </Modal>
    </>
  );
...
export default WeComSignInButton;
