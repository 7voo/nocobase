...
import { QRCode, Button, Space, Typography, Spin, Alert } from 'antd';
...
/**
 * Props for WeComQRCode component
 */
export interface WeComQRCodeProps {
  /**
   * Authenticator name
   */
 ...
 */
export const WeComQRCode: React.FC<WeComQRCodeProps> = ({
  authenticator,
  onError,
    ...
    <div style={{ textAlign: 'center', padding: '20px 0' }}>
      <Space direction="vertical" size="middle" style={{ width: '100%' }}>
        ...
        <div style={{ position: 'relative', display: 'inline-block' }}>
          <QRCode value={authUrl} size={200} status={expired ? 'expired' : 'active'} />
